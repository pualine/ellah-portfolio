...
import { ellahLogo2 } from "../../assets/index";
...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-24 sticky top-0 z-50 bg-bodyColor mx-auto flex justify-between items-center font-titleFont border-b-[1px] border-b-designColor">
      <div className="mr-5 pr-20">
        
        <Link to="/"><img src={ellahLogo2} alt="logo" className="w-20" /> </Link>
      </div>
      <div>
        ...
        {showMenu && (
          <div className="w-[80%] h-screen overflow-scroll absolute top-0 left-0 bg-gray-900 p-4 scrollbar-hide">
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                <img className="w-32" src={ellahLogo2} alt="logo" />
